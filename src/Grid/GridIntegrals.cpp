...
void GetDensity2Skeleton(
		double * aos,
		double * ao1xs,double * ao1ys,double * ao1zs,
		double * ao2xxs,double * ao2yys,double * ao2zzs,
		double * ao2xys,double * ao2xzs,double * ao2yzs,
		int ngrids,EigenMatrix D,
		int atom1,int atom2,int * bf2atom,
		double * dnnxxs,double * dnnxys,double * dnnxzs,
		double * dnnyxs,double * dnnyys,double * dnnyzs,
		double * dnnzxs,double * dnnzys,double * dnnzzs){
	//double * iao=aos; // AOs
	double * jao=aos;
	...
	for (int ibasis=0;ibasis<D.cols();ibasis++){
		...
		for (int jbasis=0;jbasis<D.cols();jbasis++){
			...
			for (long int kgrid=0;kgrid<ngrids;kgrid++){
				dnnxxs[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*ixx[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*ix[kgrid]*jx[kgrid]);
				dnnxys[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*ixy[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*ix[kgrid]*jy[kgrid]);
				dnnxzs[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*ixz[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*ix[kgrid]*jz[kgrid]);

				dnnyxs[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*ixy[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*iy[kgrid]*jx[kgrid]);
				dnnyys[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*iyy[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*iy[kgrid]*jy[kgrid]);
				dnnyzs[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*iyz[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*iy[kgrid]*jz[kgrid]);

				dnnzxs[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*ixz[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*iz[kgrid]*jx[kgrid]);
				dnnzys[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*iyz[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*iz[kgrid]*jy[kgrid]);
				dnnzzs[kgrid]+=2*Dij*((bf2atom[ibasis]==atom1 && bf2atom[ibasis]==atom2)*izz[kgrid]*jao[kgrid]+(bf2atom[ibasis]==atom1 && bf2atom[jbasis]==atom2)*iz[kgrid]*jz[kgrid]);
			}
		}
	}
}
